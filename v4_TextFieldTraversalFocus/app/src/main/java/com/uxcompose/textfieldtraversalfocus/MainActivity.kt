...
fun TraversalFocusScreen() {
    ...
    Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
        Column(
            ...
            NonWorkingFocusTraversalSection()
            SimpleTextEntryExample()
...
fun FocusTraversalSection() {
    Column(verticalArrangement = spacedBy(16.dp)) {
        ...
        Text(
            text = " Use the 'TAB' key on the keyboard to move between the TextFields.  This is using maxLines is equal to 1 and the single line is set to true",
    ...
    OutlinedTextField(
        ...
        trailingIcon = {
            if (text.isNotEmpty() || isFocused) {
                IconButton(onClick = { text = "clicked icon" }) {
...
fun NonWorkingFocusTraversalSection() {
...
fun FocusTraversalSectionOption() {
    Column(verticalArrangement = spacedBy(16.dp), modifier = Modifier.background(MaterialTheme.colorScheme.errorContainer)) {
        ...
        Column(verticalArrangement = spacedBy(16.dp)) {
            repeat(4) { index ->
                FocusableTextFieldTest(label = "TextField $index")
            }
        }
    }
}
...
fun InputTrappingActions() {
    ...
    var showBottomWithTextField by remember { mutableStateOf(false) }
    ...
    Card(
        ...
        Column(
            ...
            ElevatedButton(onClick = { showBottomWithTextField = true }, modifier = Modifier.fillMaxWidth()) {
...
@Composable
fun SimpleTextEntryExample() {
    // State for each of the four text fields
    ...
    Box(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                label = { Text("Input Field 4") }
            )
        }
    }
}
// A preview so you can see the form in the Android Studio designer
@Preview(showBackground = true)
@Composable
fun SimpleTextEntryFormPreview() {
    SimpleTextEntryExample()
}
...
fun MyScreen() {
    ...
    Box(
        ...
        Column(
            ...
            // 2. Password (Uses VisualTransformation to hide text)
            CustomIconTextField(
                value = password,
            ...
            // 5. Zip Code (Numeric Keyboard)
            CustomIconTextField(
                value = zip,
                onValueChange = { if (it.length <= 5) zip = it }, // Limit to 5 chars
                label = "Zip Code",
