...
object MovieList {
    ...
    private fun setupMovies(): List<Movie> {
        val title = arrayOf(
            "Bad Bunny A Year in Review",
            "Bad Bunny times 2 for the Super Bowl",
            "Bad Bunny Political Pivot",
            "Bad Bunny 200M PR Boost",
            "Bad Bunny Global Takeover"
        )

        val description = "Bad Bunny A Year in Review "
        val studio = arrayOf(
            "Big Bad Wolf",
            "Bad News Bears",
            "Bad Dreams",
        ...
        val bgImageUrl = arrayOf(
            "https://feliciachamberlain.com/2026/android/bbbbg.png",
            "https://feliciachamberlain.com/2026/android/2bbbbg.png",
